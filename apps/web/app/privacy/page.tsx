/**
 * Privacy Policy page. Placeholder content per research.md; legal copy to be added later.
 */
...
export const metadata = {
  title: "Privacy Policy | TuitionLift",
  description: "TuitionLift privacy policy",
};
    ...
    <div className="min-h-svh bg-linear-to-b from-navy via-navy to-navy/95 font-body">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="mt-4 text-off-white/80">
          ...
          privacy policy. Placeholder content—legal copy to be added before
          launch.
        </p>
      </main>
      <LandingFooter />
